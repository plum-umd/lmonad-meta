...
eraseEvalEraseSimulation l t@(TLabel t1 t2) = undefined
eraseEvalEraseSimulation l t@(TLabelOf t1) = undefined
eraseEvalEraseSimulation l t@(TToLabeled t1 t2) = undefined
